...
{
    [AjaxNamespace("CentrographyAjax")]
    public partial class Centrography : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(Centrography));
        ...
        [AjaxMethod]
        public List<Earthquake> CentralizeTest2(List<Earthquake> list, string stepCount)
        {
